...
export const CANDIDATI: Candidat[] = [
  ...
  { id: 'c1', nume: 'Ana Georgescu', titlu: 'Directorul Anului pentru Inovare', scoala: 'Liceul Teoretic "Ion Creangă"', regiune: Regiune.BUCURESTI_ILFOV, categorieIds: ['cat1', 'cat3'], pozaUrl: 'https://i.pravatar.cc/150?u=c1', promotions: { 'etapa1': true, 'etapa2': true, 'etapa3': true, 'etapa4': true }, submissionText: 'Proiect pilot de transformare digitală în școală: am implementat un program de leadership educațional care a folosit tehnologie pentru a crește implicarea elevilor. Rezultatele preliminare arată creșteri ale participării la activități extracurriculare și îmbunătățiri ale performanței la științe.' },
  { id: 'c3', nume: 'Eva Matei', titlu: 'Directorul Anului pentru Inovare', scoala: 'Colegiul Economic "Octav Onicescu"', regiune: Regiune.NORD_EST, categorieIds: ['cat1'], pozaUrl: 'https://i.pravatar.cc/150?u=c3', promotions: { 'etapa1': true, 'etapa2': true }, submissionText: 'Inițiativă comunitară pentru incluziune: am creat parteneriate locale cu ONG-uri și companii pentru a oferi mentorat elevilor vulnerabili și a dezvolta ateliere practice de antreprenoriat.' },
  { id: 'c5', nume: 'Carmen Stanciu', titlu: 'Directorul Anului pentru Inovare', scoala: 'Școala Gimnazială "Avram Iancu"', regiune: Regiune.NORD_VEST, categorieIds: ['cat1'], pozaUrl: 'https://i.pravatar.cc/150?u=c5', promotions: {}, submissionText: 'Program de digitalizare a bibliotecii școlii și formare pentru profesori în utilizarea resurselor online, pentru a susține predarea diferențiată și accesul la materiale educaționale moderne.' },

  // Categoria Egalitate de Sanse
  { id: 'c2', nume: 'Bogdan Dumitrescu', titlu: 'Directorul Anului pentru Egalitate de Sanse', scoala: 'Colegiul Național "Andrei Șaguna"', regiune: Regiune.CENTRU, categorieIds: ['cat2'], pozaUrl: 'https://i.pravatar.cc/150?u=c2', promotions: { 'etapa1': true, 'etapa2': true, 'etapa3': true, 'etapa4': true }, submissionText: 'Proiect de incluziune școlară axat pe prevenirea abandonului: am implementat programe de tutoring, consiliere și implicare a părinților, obținând scăderi ale absenteismului.' },
  { id: 'c4', nume: 'David Antonescu', titlu: 'Directorul Anului pentru Egalitate de Sanse', scoala: 'Liceul Tehnologic "Constantin Brâncuși"', regiune: Regiune.SUD_VEST_OLTENIA, categorieIds: ['cat2'], pozaUrl: 'https://i.pravatar.cc/150?u=c4', promotions: { 'etapa1': true, 'etapa2': true, 'etapa3': true }, submissionText: 'Inițiativă pentru egalitate de șanse: programe de burse pentru elevi din medii defavorizate și ateliere de dezvoltare a competențelor socio-emoționale.' },
  
  // Categoria Antreprenoriat
  { id: 'c6', nume: 'Mihai Popa', titlu: 'Directorul Anului pentru Antreprenoriat', scoala: 'Liceul de Arte "Hariclea Darclée"', regiune: Regiune.SUD_EST, categorieIds: ['cat3'], pozaUrl: 'https://i.pravatar.cc/150?u=c6', promotions: { 'etapa1': true, 'etapa2': true, 'etapa3': true, 'etapa4': true }, submissionText: 'Program de antreprenoriat pentru liceeni: am lansat un incubator școlar care sprijină elevii în dezvoltarea ideilor de afaceri, oferind mentorat și acces la resurse locale.' },
];
